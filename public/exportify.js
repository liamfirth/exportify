window.Helpers = {
  authorize: function() {
    ...
    if (client_id == '') {
      client_id = "309b4162c1af45f882864e6ff0427705"
    }
...
var PlaylistRow = React.createClass({
  exportPlaylist: function() {
    PlaylistExporter.postExport(this.props.access_token, this.props.playlist);
  },
...
var PlaylistExporter = {
  ...
  postExport: function(access_token, playlist) {
    this.csvData(access_token, playlist).then(function(data) {
      var csrf_token = $('meta[name="_token"]').attr('content');
      $.post('/export', {
        csv: data + "&_token=" + csrf_token
      });
    });
  },
